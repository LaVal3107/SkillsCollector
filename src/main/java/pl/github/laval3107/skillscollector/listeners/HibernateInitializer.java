package pl.github.laval3107.skillscollector.listeners;
...
import pl.github.laval3107.skillscollector.entityes.Skill;
import pl.github.laval3107.skillscollector.entityes.Source;
import pl.github.laval3107.skillscollector.entityes.User;
...
public class HibernateInitializer implements ServletContextListener {
    ...
    public static final String SESSION_FACTORY_ATTR = "session_factory";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            sce.getServletContext().setAttribute(SESSION_FACTORY_ATTR, sessionFactory);

//            SessionFactory sessionFactory1 = (SessionFactory) sce.getServletContext().getAttribute(HibernateInitializer.SESSION_FACTORY_ATTR);
        } catch (Exception e) {
